    ...
    <section className="bg-white" style={{ borderBottom: '1px solid #e0e0e0' }}>
      <div className="max-w-5xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="rounded-2xl p-8 md:p-10 flex flex-col justify-center" style={{ background: '#F5F3EF', border: '2px solid #1A1A1A' }}>
          ...
          {/* Right Block — Mission Statement */}
          <div className="rounded-2xl p-8 md:p-10 flex flex-col justify-center" style={{ background: '#1A1A1A' }}>
