        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
          ...
          <div key={event.id} className="rounded-2xl overflow-hidden bg-white transition-all hover:shadow-xl hover:-translate-y-1 flex flex-col" style={{ border: '1px solid #C99738', boxShadow: '0 2px 12px rgba(0,0,0,0.06)' }}>
              ...
              <div className="relative h-40 overflow-hidden">
                <img src="https://media.base44.com/images/public/6a2feeb0292b105992c98be7/56172c89e_IMG_0727.jpeg" alt={event.title} className="w-full h-full object-cover" onError={(e) => {e.target.onerror = null;e.target.src = PLACEHOLDER_IMG;}} />
