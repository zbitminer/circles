        ...
        <div className="max-w-6xl mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-1.5 text-sm" style={{ color: '#999' }}>
                <li><Link to="/opportunities" className="transition-colors hover:text-white">Opportunities</Link></li>
                <li><Link to="/sos" className="transition-colors hover:text-white">S.O.S. Requests</Link></li>
                ...
                <li><Link to="/feed" className="transition-colors hover:text-white">Community Feed</Link></li>
                <li><Link to="/directory" className="transition-colors hover:text-white">Directory</Link></li>
                ...
                <li><Link to="/trust" className="transition-colors hover:text-white">Trust & Safety</Link></li>
