    ...
    <div className="max-w-4xl mx-auto px-4 py-8 pb-24 md:pb-8">
      ...
      {showForm && !user && (
        <div className="bg-amber-50 border border-amber-200 rounded-2xl p-6 mb-6 text-center">
          ...
          <h3 className="font-semibold text-amber-900 mb-1">Sign in to host a meal</h3>
          <p className="text-sm text-amber-700 mb-4">You need to be signed in to list a Shabbat meal.</p>
          <a href="/login" className="inline-block bg-amber-500 text-white px-6 py-2.5 rounded-xl font-semibold text-sm hover:opacity-90 transition-opacity">Sign In</a>
        </div>
      )}
      {showForm && user && (
